...
const videos = [
  'https://res.cloudinary.com/dzlwqa2er/video/upload/lebron-james-compressed_q6zpvj.mp4', // LeBron James
];
...
export default function HeroSection() {
  ...
  return (
    <section className={styles.hero} onClick={handleHeroClick}>
      <video
        src="https://res.cloudinary.com/dzlwqa2er/video/upload/lebron-james-compressed_q6zpvj.mp4"
        autoPlay
        muted
        playsInline
        loop
